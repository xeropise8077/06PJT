...
<form name="addPurchase" method="post" action="/addPurchase.do?prodNo=${ product.prodNo}" target="rightframe">
...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<td bgcolor="D6D6D6" width="1"></td>
		<td class="ct_write01">${ requestScope.user.userId }<%--=user.getUserId() --%></td>
			...
			<table border="0" cellspacing="0" cellpadding="0">
				<tr>
					...
					<td background="/images/ct_btnbg02.gif" class="ct_btn01" style="padding-top: 3px;">
						<a href="javascript:fncAddPurchase();" target="rightFrame">구매</a>
					</td>
